          ...
          phoneAddictions.forEach(addiction => {
            addiction.apps.forEach(app => {
              allApps.push({ app, addictionId: addiction.id });
                ...
                return (
                  <div
                    className={`bg-gray-900 rounded-xl p-4 border-2 text-left transition-all hover:scale-105 ${
                      isBlocked
                        ? "border-red-500/50"
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      <div>
                        ...
                        <p className="text-[10px] text-gray-500 mt-0.5">{daysClean} days tracking</p>
                      </div>
                    </div>
                    <div className="inline-flex flex-col bg-gray-800 rounded-lg px-2.5 py-1.5 border border-gray-700 mb-3 max-w-[120px]">
              ...
              {otherAddictions.map((addiction) => {
                ...
                return (
                  <button
                    ...
                    className="bg-gray-900 rounded-xl p-4 border-2 border-gray-800 text-left transition-all hover:scale-105 hover:border-orange-500/50"
                  >
                    <div className="text-3xl mb-2">{getAddictionIcon(addiction)}</div>
                    <h3 className="text-lg font-semibold text-white mb-1.5">{addiction.name}</h3>
                    <p className="text-xs text-gray-400 mb-3">{daysClean} days clean</p>
                    
                    {/* Live Countdown Timer */}
                    <div className="bg-gray-800 rounded-lg p-3 mb-2.5">
