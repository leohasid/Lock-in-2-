                  ...
                  >
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="text-right">
                        <p className="text-lg font-bold text-white">{formatMinutes(totalCurrentUsage)}</p>
                        <p className="text-xs text-gray-400">of {formatMinutes(totalDailyLimit)}</p>
                      </div>
                    </div>
                    {allApps.length > 0 && (
                    ...
                    <div className="flex items-center justify-between">
                      <button
                        ...
                        className="bg-orange-500 hover:bg-orange-600 text-black px-3 py-1.5 rounded-lg text-xs font-semibold transition-colors"
                      >
                        View Details
                      </button>
                      {isBlocked && (
                        <span className="bg-red-600 text-white text-[10px] px-2 py-1 rounded-full font-semibold">
                          BLOCKED
                        </span>
                      )}
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <div className="flex gap-2 text-center">
                          <div>
                            <div className="text-base font-bold text-white">{elapsed.days ?? 0}</div>
                            <div className="text-[9px] text-gray-400">D</div>
                          </div>
                          <div>
                            <div className="text-base font-bold text-white">{elapsed.hours ?? 0}</div>
                            <div className="text-[9px] text-gray-400">H</div>
                          </div>
                          <div>
                            <div className="text-base font-bold text-white">{elapsed.minutes ?? 0}</div>
                            <div className="text-[9px] text-gray-400">M</div>
                          </div>
                        </div>
                        {money && (
                          <div className="text-xs text-green-400 font-semibold mt-1">
                            {money.currency}{money.total.toLocaleString(undefined, { maximumFractionDigits: 0 })}
                          </div>
                        )}
                      </div>
                    </div>
