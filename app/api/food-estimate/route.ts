...
{"foods":[{"name":"","calories":0,"protein_g":0,"carbs_g":0,"fat_g":0}],"total_calories":0,"total_protein_g":0,"total_carbs_g":0,"total_fat_g":0}`;
    ...
    // Timeout before Vercel kills us (60s) - return friendly error instead of 502
    ...
    const outputText = await Promise.race([
      ...
      new Promise<never>((_, reject) =>
        setTimeout(() => reject(new Error("Request timed out. Please try again with a smaller image.")), AI_TIMEOUT_MS)
      ),
    ]);
